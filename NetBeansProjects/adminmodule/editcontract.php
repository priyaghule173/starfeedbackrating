       ...
       /*
           ...
           // print_r("dwempid=" . $dwempid);
            ...
            print_r($currentdw);*/
             ...
             //  $upskills = implode(",",$currentdw['majorskills']);
...
if (isset($_REQUEST['search'])) {
  ...
  /*  
    if ($_REQUEST['v_dwempid'] !== "") {
        $dwempid = $_REQUEST['v_dwempid'];
        $sql = "SELECT * FROM `contracts` WHERE `dwempid` ='" . $dwempid . "'";
   ...
   print_r($currentdw);*/
    $skills =array_map('trim',explode(",",$currentdw['majorskills']));
            ...
            <div class="col-md-12">
                <form class="form-horizontal demo-form" enctype="multipart/form-data" name="contract Form" data-parsley-validate="" method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control"  name="v_contractid" required="" readonly="" value="<?php echo $currentdw['contractid'] ?>" >
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="date" class="form-control" name="v_startdate" value="<?php echo $currentdw['startdate'] ?>">
                        </div>
                        ...
                        <div class="col-md-4">
                            <input type="date" class="form-control" name="v_enddate" id="v_doj" value="<?php echo $currentdw['enddate'] ?>">
                        </div>
                    </div>
...
<label class="control-label col-md-2">Select Daily Start  Time :</label>
                        ...
                        <div class="col-md-4">
                            <input  class="form-control" type="time" name="v_dailystarttime" placeholder="click to show timepicker" value="<?php echo $currentdw['dailystarttime'] ?>" >  
                        </div>
<label class="control-label col-md-2">Select Daily End  Time :</label>
                        <div class="col-md-4">
                            <input  class="form-control" type="time" name="v_dailyendtime" placeholder="click to show timepicker"  value="<?php echo $currentdw['dailyendtime'] ?>" >  
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="v_sallary" class="form-control" value="<?php echo $currentdw['sallary'] ?>">
                        </div> 
                        <label class="control-label col-md-2"> Notes</label>

                        <div class="col-md-4">
                            <textarea  name="v_dwempnotes" class="form-control" > <?php echo $currentdw['dwempnotes'] ?></textarea>
                        </div> 
                    </div> 
                    <div class="form-navigation">
                         <a href="<?php echo site_url() . '/searchcontract' ; ?>"> <button  type="button" class="btn  pull-left" >Cancel</button></a>
