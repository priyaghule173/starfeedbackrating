...
//    AND  `jobdate` =  '" . $date . "'";
//
//    $prevRatingResult = dwqueryexec(__FUNCTION__, $sql);
//    $resultrating = mysqli_fetch_all($prevRatingResult, MYSQLI_ASSOC);
    ...
    // $query = "INSERT INTO `unitjobs` (`dwid`,`contractid`,`feedback`,`jobdate`,`modified`) VALUES('" . $dwid . "','" . $contractid . "','" . $dwempid . "','" . $ratingNum . "','" . date("Y-m-d") . "','" . date("Y-m-d") . "')";
    ...
    /*
      ...
      $avgsql = "SELECT SUM(`feedback`)/COUNT(`feedback`) as avgfeedback FROM  `unitjobs` WHERE  `contractid` ='" . $contractid . "' AND '" . $lastmonth . "'";

      $avgrat = dwqueryexec(__FUNCTION__, $avgsql);
      $avgrating = mysqli_fetch_all($avgrat, MYSQLI_ASSOC);
      //round
      $finalrating = round($avgrating[0]['avgfeedback']);

      $dwid = $_REQUEST['v_dwid'];
      $rat = array();
      $sql = 'UPDATE `dws` SET ';
      $sql .= '`avgrating`=' . $finalrating;
      $sql .= " WHERE `dwid`='" . $dwid . "'";
      //echo $sql;
      $data = dwqueryexec(__FUNCTION__, $sql);
      $rat = mysqli_fetch_all($data, MYSQLI_ASSOC);
      // print_r($rat);
     */
}
...
//if (isset($_REQUEST['request_replacement'])) {
//    /* $callerdw = getDW($CallFrom);
//      $callerdwid = $callerdw['dwid'];
//
//
//      $tomorrow = date("Y-m-d", strtotime('tomorrow'));
//
//      // Get contracts for dwid
//      $allcontracts=getdwidContracts($callerdwid);
//
//      dwerror_log("storedayendattend: allcontracts=" .print_r($allcontracts,TRUE));
//      //echo "storenextdayattend: allcontracts=" .print_r($allcontracts,TRUE);
//     */
//    print_r($thisemployer);
//    if ($thisemployer['subscription'] == "paid") {
//        askReplacement($thisemployer['dwempid'], $thisemployer['area'], $thisemployer['regmobile']);
//        // askReplacement
//    }
?>
                    ...
                    <ul class="nav navbar-nav" style="list-style-type: none;">
                        ...
                        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="contract">
                            <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseContracts1" data-parent="#exampleAccordion">
                                ...
                                <a href="https://aideexpert.freshdesk.com/support/tickets/new">
...
<!--  website -->
                        ...
                        <li class="sider-menu">
                            ...
                            <ul>
                                ...
                                <li><a href="<?php echo site_url() . "/requesthelper" ?>" style="color: #3BACA9;"><span class="fa fa-search-plus"></span> Request For Helper</a></li>
                                <li><a href="<?php echo site_url() . "/registermydw" ?>" style="color: #3BACA9;"><span class="fa fa-registered"></span> Register My DW</a></li>
                                <li><a href="https://aideexpert.freshdesk.com/support/tickets/new" style="color: #3BACA9;"><span class="fa fa-phone"></span> Contact AideExpert</a></li>
                                <li>
                                    ...
                                    <form class="form-horizontal demo-form" name="searchdw" data-parsley-validate="" method="POST"action="<?php echo get_permalink(); ?>">
                                        ...
                                        <?php if (!$contractsRegistered) { ?>
                                            <div class="alert alert-block alert-success">
                                                ...
                                                You can  <a href="<?php echo site_url() . "/registermydw" ?>"><b>Register</b></a> your domestic worker or you can  <a href="<?php echo site_url() . "/requesthelper" ?>"><b>Request</b></a> for domestic helper.
...
//print_r($rating);
                                ...
                                <form class="form-horizontal demo-form" name="notes" data-parsley-validate="" method="POST"action="<?php echo get_permalink(); ?>">
                                    ...
                                    <div class="content-box" style="height: 80px;">
                                        <div class="form-group">
                                            <textarea rows="3" class="form-control" name="v_dwempnotes" style=overflow:scroll"><?php
                                                foreach ($allcontracts as $col) {
...
{?>                                              <button type="button" name="Pay_subscription" value="Pay Bonus" style="background-color: #3BACA9;" disabled><font color="white">Pay</font></button>

<?php
}else{
?>
                             <a href="<?php echo site_url() . "/paymentreqsub?v_dwempid=" . $dwempid . '&v_contractid=' . $contractid; ?>"><button type="button" name="Pay_subscription" value="Pay Bonus" style="background-color: #3BACA9;" ><font color="white">Pay</font></button></a>
