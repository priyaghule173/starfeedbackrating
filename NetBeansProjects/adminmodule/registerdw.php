...
if (isset($_REQUEST['submit'])) {
    ...
    if ($GLOBALS['conn']->error) {
        //Error
        echo "<script>alert(' Oops! something went wrong. Please enter domestic worker data again.'); document.location='".site_url()."/registerdw';</script>";
 ...
 sendSms($myregid[0]['regmobile'],$msg);
        ...
        echo "<script>alert('Domestic Worker registration successfully. AideExpert Registration Id = " . $myregid[0]['regid'] . "  ');document.location='".site_url()."/adminhome';</script>";
                ...
                <form class="form-horizontal demo-form" enctype="multipart/form-data" name="registration" data-parsley-validate="" method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <label >
                                    <input type="radio" name="v_empstatus" required="" value="Y" >Looking For A Job</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="v_dwsupportid"  id="v_leadid" placeholder="Enter Group Leader Id" required="">
                            </div>

                            <label class="control-label col-md-2">Group Leader Name</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="v_supportname" id="v_leadname" placeholder="Enter Group Leader Name" required="" >
                            </div>
                        </div>
                        <!--form-group 2 ends-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="number" class="form-control"  name="v_supportmobile" id="v_leadno" placeholder="Enter Leader Mobile No." required="" data-parsley-minlength="10" data-parsley-maxlength="10">
                            </div>

                            <label class="control-label col-md-2">Select Group Name</label>

                            <div class="col-md-4">
                                <input type="text" name="v_groupname" class="form-control" id="v_groupname" placeholder="Enter Group Name" required="">
